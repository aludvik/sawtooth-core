...
impl<T: NotifierService> ConsensusNotifier for T {
    ...
    fn notify_block_new(&self, block: &Block) {
        ...
        consensus_block.set_previous_id(from_hex(&block.previous_block_id, "block.previous_block_id"));
        consensus_block.set_signer_id(from_hex(&block.signer_public_key, "block.signer_public_key"));
