...
class ConsensusSendToHandler(ConsensusServiceHandler):
    ...
    @staticmethod
    def request_type():
        return validator_pb2.Message.CONSENSUS_SEND_TO_REQUEST
...
class ConsensusBroadcastHandler(ConsensusServiceHandler):
    ...
    @staticmethod
    def request_type():
        return validator_pb2.Message.CONSENSUS_BROADCAST_REQUEST
...
class ConsensusInitializeBlockHandler(ConsensusServiceHandler):
    ...
    @staticmethod
    def request_type():
        return validator_pb2.Message.CONSENSUS_INITIALIZE_BLOCK_REQUEST
...
class ConsensusCancelBlockHandler(ConsensusServiceHandler):
    ...
    @staticmethod
    def request_type():
        return validator_pb2.Message.CONSENSUS_CANCEL_BLOCK_REQUEST
...
class ConsensusCheckBlockHandler(ConsensusServiceHandler):
    ...
    @staticmethod
    def request_type():
        return validator_pb2.Message.CONSENSUS_CHECK_BLOCK_REQUEST
...
class ConsensusCommitBlockHandler(ConsensusServiceHandler):
    ...
    @staticmethod
    def request_type():
        return validator_pb2.Message.CONSENSUS_COMMIT_BLOCK_REQUEST
...
class ConsensusIgnoreBlockHandler(ConsensusServiceHandler):
    ...
    @staticmethod
    def request_type():
        return validator_pb2.Message.CONSENSUS_IGNORE_BLOCK_REQUEST
...
class ConsensusFailBlockHandler(ConsensusServiceHandler):
    ...
    @staticmethod
    def request_type():
        return validator_pb2.Message.CONSENSUS_FAIL_BLOCK_REQUEST
...
class ConsensusBlocksGetHandler(ConsensusServiceHandler):
    ...
    @staticmethod
    def request_type():
        return validator_pb2.Message.CONSENSUS_BLOCKS_GET_REQUEST
...
class ConsensusSettingsGetHandler(ConsensusServiceHandler):
    ...
    @staticmethod
    def request_type():
        return validator_pb2.Message.CONSENSUS_SETTINGS_GET_REQUEST

    def handle_request(self, request, response):
        self._proxy.settings_get(request.block_id, request.settings)
...
class ConsensusStateGetHandler(ConsensusServiceHandler):
    ...
    @staticmethod
    def request_type():
        return validator_pb2.Message.CONSENSUS_STATE_GET_REQUEST
